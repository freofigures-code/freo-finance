...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate login for this prototype and redirect to dashboard
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      {/* Background ambient glow effect based on logo */}
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-[var(--card)] py-8 px-4 shadow-2xl border border-[var(--border)] sm:rounded-xl sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder="solvia.oficial@gmail.com"
                />
              </div>
            </div>
            ...
            <div>
              <Button type="submit" className="w-full h-11 text-base font-bold tracking-wide">
                Entrar
              </Button>
            </div>
          </form>
